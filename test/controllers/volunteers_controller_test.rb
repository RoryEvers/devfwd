...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { job_id: @volunteer.job_id, profile_id: @volunteer.profile_id } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { job_id: @volunteer.job_id, profile_id: @volunteer.profile_id } }
